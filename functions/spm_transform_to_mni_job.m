%-----------------------------------------------------------------------
% Job saved on 25-Feb-2024 17:55:20 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{1}.spm.spatial.normalise.estwrite.eoptions.tpm = {'/Users/timur/MATLAB-Drive/spm12/tpm/TPM.nii'};
...
matlabbatch{1}.spm.spatial.normalise.estwrite.woptions.interp = 0;
